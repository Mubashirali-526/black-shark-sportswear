...
export const metadata: Metadata = {
  title: "Bags",
  description:
    "Durable sports bags and backpacks built to carry your gear through training, travel and game day — premium materials, gold-accented hardware.",
};

export default async function BagsPage() {
  const categories = await getSiteCategories();
  const otherCategories = categories.filter((c) => c.slug !== "bags");
  const subNames = await getSiteSubcategories("bags");
        ...
        <div className="container-x relative">
          <Reveal>
            ...
            <p className="mt-6 max-w-2xl text-sm leading-relaxed text-white/65 sm:text-base">
              Durable sports bags and backpacks built to carry your gear
              through training, travel and game day — premium materials,
              gold-accented hardware.
            </p>
